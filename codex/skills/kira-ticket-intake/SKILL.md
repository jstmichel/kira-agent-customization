...
description: Use when you need to intake a GitHub issue, GitHub pull request, or Azure DevOps work item and normalize it into a compact ticket packet with acceptance criteria, execution guidance, risks, linked artifacts, and missing inputs.
...
3. Prefer the narrowest CLI or connector fetch that returns useful fields without excessive chatter.
...
- Otherwise prefer `gh issue view <id> --comments` for issues when comment context matters.
